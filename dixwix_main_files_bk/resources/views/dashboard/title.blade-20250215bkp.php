...
<?php $isAdmin=false;$mCls=3;$csttxt='cst';
        ...
        <div class="row">
            ...
            <!-- Instances Card -->
            <div class="col-md-{{$mCls}} mb-4">
                <div class="card-counter" style="background-color: #8775A7; color: #fff;" data-id="loans">
            ...
            <!-- Data Card -->
            <div class="col-md-{{$mCls}} mb-4">
                <div class="card-counter info" id="data-card" data-id='{{$csttxt}}'>
                    <i class="fa fa-users"></i>
                    <span class="count-numbers"><?php if($isAdmin){echo$data['totalusers'];}else{echo$data['unicustomer'];}?></span>
