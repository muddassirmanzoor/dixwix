...
{
$userItemLocations = json_decode(\App\Models\User::find($book['created_by'])->locations, true) ?? [];
}
elseif (!is_null(auth()->user()->locations)) {
...
<div class="container">
    ...
    <div id="manual_tab" class="tabcontent">
        <div class="main-box-amazon">
            <div class="box-form-tab1">
                <form name="add-book-form" id="add-book-form" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                        <div class="select3">
                            <div>
                                <h3 class="lead main-heading">Item ID *</h3>
                                @php
                                $item_id = "";
                                if ($retdata['mode'] === "add") {
                                ...
                                @endphp
                                <input type="text" class="form-control allinput" id="item_id" name="book[item_id]" value="{{ $item_id }}" class="form-control" placeholder="Enter the Item ID here" />
                            ...
                            <div>
                                <h3 class="lead main-heading">Select Item Category *</h3>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h3 class="lead main-heading">Purchase Price *</h3>
                                        <input type="number" class="form-control allinput" id="price" name="book[price]" value="{{ isset($book) ? $book['price'] : '' }}" class="form-control" min=1 placeholder="Price" step=".01" />
                                    ...
                                    <div class="col">
                                        <h3 class="lead main-heading">Rent Price *</h3>
                    ...
                    <div>
                        ...
                        <select class="form-control selectpicker allinput" id="locations" name="book[locations][]" multiple>
                            @php $isFirstOption = true; @endphp
                            @foreach ($userItemLocations as $location)
                            @php
                            $selected = '';
                            if ($mode == 'edit') {
                            $locationsArray = isset($book) ? json_decode($book['locations'], true) : [];
            ...
            <br>
            <h3 class="lead main-heading">No. of Copies *</h3>
            ...
            <br />
            <h3 class="lead main-heading">Cover image *</h3>
