<style>
    .link_with_img_member {
        ...
        border: 1px solid #003d4c; /* Optional border */
    }

    .link_with_img_member img {
...
<div class="content">
    <div class="container">
        <div class="heading mb-4">
            ...
            <a id="membership" href="{{ route("membership") }}" class="btn link_with_img_member">
                <img src="{{ url('assets/media/membership.png') }}" alt="Membership Icon"> Membership
            </a>
        </div>
