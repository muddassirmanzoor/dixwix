...
{{--                                        <td>{{ $book['description'] }}</td>--}}
                                        ...
                                        <td style="text-align: center">
                                            ...
                                            @endforeach
                                            @if($is_reserved)
                                            <span class="badge badge-warning px-4 py-2"><span class="badge badge-success px-2 py-1">{{ $pending_count }} </span> <a href="#tab4" style="text-decoration: none;color: #212529;">Approval pending</a></span>
