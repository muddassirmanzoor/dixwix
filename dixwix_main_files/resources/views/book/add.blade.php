...
<div class="container">
    ...
    @if (isset($err_message))
    	<div class="error_msg">* {!! $err_message !!}  Please <a href="https://www.dixwix.com/contact-us" target="_blank" rel="noopener">Contact Us</a>.</div>
    @endif
    ...
    @error('csv_url')
    <div class="alert alert-danger">{{ $message }}  Please <a href="https://www.dixwix.com/contact-us" target="_blank" rel="noopener">Contact Us</a>.</div>
    @endif
    ...
    <div class="tab d-flex flex-column w-100 flex-md-row">
        ...
        @if ($mode == "add")
        <button id="csv_entry_btn" class="tablinks w-100" onclick="openEntryTab(this, 'csv_tab')">Bulk import</button>
        <button id="amazon_entry_btn" class="tablinks w-100" onclick="openEntryTab(this, 'amazon_tab')">Search and Import</button>
        @endif
    </div>
...
{{--                        <input class="form-control" id="csv_url" type="url" name="csv_url" placeholder="https://docs.google.com/spreadsheets/d/{sheet_id}/edit?gid={sheet_tab_id} or direct file URL" />--}}
            ...
            <div class="text-box">
                ...
                <a href="{{ url('book_import_sample.xlsx') }}" download="Sample File.xlsx">Sample CSV File</a><br>
                <a href="https://docs.google.com/spreadsheets/d/1xg08TwpolWDYyrNMlOGOjQrsSDOS_oEwckJYm0DgSI8/edit?gid=0#gid=0" target="_blank">Google Sheet Sample File</a>
            </div>
        </div>
    </div>
