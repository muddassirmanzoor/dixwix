...
<script language="JavaScript">
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (!res.notifications || res.notifications.length === 0) {
                    ...
                    notifyTitleCounter.textContent = 0;
                    return;
                }

                // Add new notifications
                res.notifications.forEach(notification => {
                    let createdAt = new Date(notification.created_at).toLocaleString();
                    let title = notification.data.title || 'View details';
                    let url = notification.data.url || '#';
                ...
                // Update counters
                badgeCounter.textContent = res.total;
                notifyTitleCounter.textContent = res.total;
                badgeCounter.classList.add("badge-success");
            },
            error: function (xhr) {
    ...
    // 🔄 Also load immediately when page opens
